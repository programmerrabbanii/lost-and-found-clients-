          ...
          <form className="space-y-4" >
            ...
            <div className="form-control relative">
              ...
              <label className="label mt-2">
                <a href="#" className="label-text-alt link link-hover text-sm text-indigo-600 hover:text-indigo-800">
                  Forgot password?
                </a>
              </label>
            </div>
            ...
            <p className="text-center"> Don't have an account?  <Link className="font-semibold" to="/register">Register here</Link></p>
          </form>
        </div>
      </div>
    </div>
